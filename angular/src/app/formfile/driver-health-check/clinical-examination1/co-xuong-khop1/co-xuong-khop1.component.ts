...
import { CertificateGroupStatusDto, CertificateGroupStatusDtoPagedResultDto, CreateMedicationKeyResultDto, KhoaCoXuongKhopServiceServiceProxy } from '@shared/service-proxies/service-proxies';
