...
@Component({
  selector: 'app-xet-nghiem-mau',
  templateUrl: './xet-nghiem-mau.component.html',
  styleUrls: ['./xet-nghiem-mau.component.css']
})
export class XetNghiemMauComponent implements OnInit{
