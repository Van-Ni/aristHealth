...
import { CertificateDto, CertificateServiceServiceProxy, CertificateTypeDto, CertificateTypeServiceServiceProxy, ClientInfoDto, CreateCertificateDto, RegionDto, RegionServiceServiceProxy, UpdateCertificateDto } from '@shared/service-proxies/service-proxies';
...
export class EditCertificateComponent extends AppComponentBase implements OnInit {
  ...
  setPrice(event: any) {
    this.certificateTypeService.get(this.certificate.certificateTypeId).subscribe(
