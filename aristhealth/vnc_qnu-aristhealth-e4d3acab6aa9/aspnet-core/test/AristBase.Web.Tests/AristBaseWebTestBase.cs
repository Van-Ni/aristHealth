...
{
    public abstract class AristBaseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AristBaseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AristBaseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AristBaseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AristBaseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AristBaseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AristBaseDbContext, Task<T>> func)
        {
            T result;
